...
data_dir <- file.path(analysis_dir, "data_CN_only/preprocessing/HRS")
temp_dir <- file.path(analysis_dir, "data_CN_only/mid_imputation/HRS")
```
...
for (index in 1:length(starts)) {
  ...
  savepath <- file.path(temp_dir, savename)
...
# re-order beta to match original ordering
beta_data <- beta_data[,colnames(dnam_data)]
